...
public class DozerConfig {
    ...
    private static final String PACKAGE_TO_SCAN = "org.academy.projects.controller.dto.mapping";

    @Bean
    /* default */ DozerBeanMapper mapper() throws ReflectiveOperationException {
